 ...
 *
 * A **stacked route, not a fifth tab**. `TabPill` stays at four items and this
 * is pushed over the shell: a tab is for a place you return to constantly, and
 * a challenge is checked once a day at most.
 *
 ...
 * to go stale — the arrangement Event progress had, and the reason
 * `resolveChallenge` is the only implementation (deviation #18).
 *
...
export default function Train() {
  ...
  // A card over the tab shell, so the orbit nav is covered rather than absent
  // and `Screen` must not reserve room for it.
...
const styles = StyleSheet.create({
  ...
  // Dashed, following `LockedSlot`: this app says "a
