...
class AppDelegate: ExpoAppDelegate {
  ...
  public override func application(
    ...
    // KAIRO: register HealthKit observer queries before the JS bridge exists
    // Reached by selector rather than `import ReactNativeHealthkit`:
    ...
    if let managerClass = NSClassFromString("ReactNativeHealthkit.BackgroundDeliveryManager") as? NSObject.Type,
      ...
      NSLog("[Kairo] HealthKit background observers NOT registered - ReactNativeHealthkit.BackgroundDeliveryManager lookup failed.")
    }
