...
SOURCES = [
    "base/kairo_base_front.png",
    "poses/kairo_pose_idle.png",
    "poses/kairo_pose_sleep.png",
    "poses/kairo_pose_walk.png",
    "poses/kairo_pose_run.png",
    "poses/kairo_pose_workout.png",
    "poses/kairo_pose_race_victory.png",
    "poses/kairo_pose_summit.png",
    "states/kairo_state_sleepy.png",
    "states/kairo_state_normal.png",
    "states/kairo_state_well_rested.png",
]
